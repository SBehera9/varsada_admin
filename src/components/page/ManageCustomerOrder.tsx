...
interface ManageCustomerOrderProps {}

const ManageCustomerOrder: React.FC<ManageCustomerOrderProps> = () => {
  return (
        ...
        <div className="border p-4 rounded-md mb-4 bg-white">
          ...
          <div className="mt-4">
            ...
            <div className="mt-4 flex space-x-4">
              <button className="px-4 py-2 bg-[#C473FF] hover:bg-[#7a3ea5] text-white rounded-md">
                Refund Now
              </button>
              <button className="px-4 py-2 bg-[#C473FF] hover:bg-[#7a3ea5] text-white rounded-md">
                Reject Refund
